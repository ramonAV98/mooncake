...
class BaseTrainer(BaseEstimator, metaclass=ABCMeta):
    ...
    def __init__(self, module, dataset, group_ids, time_idx, target,
        ...
        self.loss = self.criterion()  # needed for pytorch-forecasting models
    ...
    def fit(self, X, y=None):
        ...
        self.callbacks_ = self._eval_callbacks(train_dataset)
    ...
    def get_kwargs_for(self, name, prefix=False):
        ...
        Attributes must be of type `class`, for instance, pytorch modules and
        datasets.

        Parameters
        ----------
        name : str, {'module', 'dataset'}
            Name of the class type attribute
